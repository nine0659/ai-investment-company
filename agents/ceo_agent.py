...
→ 오늘 KOSPI 상승확률: XX% / 하락확률: YY%
→ 주도 섹터 예측 (반드시 미국 섹터 ETF 등락과 연결)
  예: "SOX +2.3% → 반도체 갭업 확률 75% / 갭다운 확률 25%, 주도 섹터: 반도체·장비"
  예: "달러인덱스 강세 + 외국인 선물 매도 → 상승확률 35% / 하락확률 65%"
...
🌙 내일 시나리오 (오늘 밤 미국 장 기반, 확률 필수)
오늘 밤 확인해야 할 미국 핵심 지표 1개
→ A (미국 강세 시): 내일 KOSPI 상승확률 XX% | 주도 섹터: OO | 포지션: 공격적
→ B (미국 약세 시): 내일 KOSPI 하락확률 YY% | 주의 섹터: OO | 포지션: 보수적/현금
