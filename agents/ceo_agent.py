...
[출력 형식 — 팩트 시트·실제 수급 데이터만 사용. 예시 텍스트 절대 출력 금지]
...
[출력 형식 — 팩트 시트·실시간 수급 데이터만 사용. 예시 텍스트 절대 출력 금지]

🧭 CIO 오전 독립 점검
오전 팩트: KOSPI [수치]([+/-X%]) | 외국인 [+/-XXX억] | 주도: [섹터]
...
🧭 CIO 오후 독립 판단
오늘 팩트: KOSPI [수치]([+/-X%]) | 외국인 [+/-XXX억] | 방향: [강세유지/박스권/약세전환]
