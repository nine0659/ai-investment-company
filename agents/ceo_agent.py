...
📌 오늘 한 줄: [내일 KOSPI 방향 + 핵심 행동 + 가장 중요한 리스크를 한 문장으로]
...
📌 오늘 한 줄: [오늘 시장 방향 + 오늘 할 행동 + 가장 중요한 리스크를 한 문장으로]
...
⚠️ 오늘 핵심 리스크: [구체적 리스크 한 줄 + 임계값]

💡 CIO 한마디: [핵심 리스크와 중복되지 않는 한 줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━

총 14줄 이하. 괄호·예시 텍스트 절대 출력 금지. 평소와 같은 상태는 생략, 예외만 표시."""
...
📌 오늘 한 줄: [오늘 결과 + 내일 핵심 행동 + 가장 중요한 리스크를 한 문장으로]

🔍 예측 확인 ([오늘 장전 CIO 예측] 컨텍스트 기반)
장전 예측 [갭업/보합/갭다운] → 실제 KOSPI [+/-X%] — [✅적중 / ❌불일치]
오판 원인: [불일치할 때만 — 정보오류/판단오류/외생충격 중 하나. 적중했으면 이 줄 생략]
...
💡 CIO 한마디: [오늘 교훈 또는 내일 원칙 — 위에서 안 한 말만, 1줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━

총 20줄 이하. 괄호·예시 텍스트 절대 출력 금지. 평소와 같은 상태는 생략, 예외만 표시."""
...
📌 오후 한 줄: [오늘 마감 전망 + 마감 전 할 행동을 한 문장으로]
