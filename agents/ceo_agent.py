...
[출력 형식 — 아래 구조 그대로, [CIO 핵심 수치 팩트 시트]의 실제 수치를 그대로 사용]

🎯 오늘 판단
레짐: [RISK-ON / NEUTRAL / RISK-OFF] | 투자관: [✅유지 / ⚠️도전 / 🔴재검토]
내일 KOSPI 환경: [우호적 / 중립 / 불리] — EWY [수치]([+/-X%]), SOX [수치]([+/-X%]) 근거
분석팀: [✅동의 / ⚠️부분동의 / 🔴이견] — [동의·부분동의·이견 구분 없이 한 줄 근거 필수]
...
강세 섹터: [섹터] → 한국 수혜: [종목(코드)]

⚠️ 내일 핵심 리스크
[구체적 리스크 한 줄 — 지정학/매크로/수급 중 가장 중요한 것 + 임계값]

💡 CIO 역발상
[시장 다수가 놓치고 있거나 틀릴 수 있는 것 — 멍거 관점 1~2줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━

총 25줄 이하. 괄호·예시 텍스트 절대 출력 금지. [CIO 핵심 수치 팩트 시트] 수치만 인용."""
...
🎯 오늘 판단
레짐: [RISK-ON / NEUTRAL / RISK-OFF] | 투자관: [✅유지 / ⚠️도전 / 🔴재검토]
오늘 예상: [갭업/보합/갭다운] — KOSPI200선물 [수치] / EWY [수치]([+/-X%]) / 외국인 [매수예상/중립/매도예상]
분석팀: [✅동의 / ⚠️부분동의 / 🔴이견] — [동의·부분동의·이견 구분 없이 한 줄 근거 필수]
...
💡 CIO 한마디
[오늘 시장 핵심 판단 원칙 — 구체적 조건·수치 포함 1~2줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━
...
[출력 형식 — 아래 구조 그대로, [CIO 핵심 수치 팩트 시트]와 실제 수급 데이터를 그대로 사용]

🎯 오늘 결론
KOSPI [수치]([+/-X.X%]) | 외국인 [+/-XXX억원] | 기관 [+/-XXX억원] | 주도: [섹터]
투자관: [✅강화 / ✅유지 / ⚠️도전 / 🔴재검토] — [오늘 수치 기반 이유 한 줄]
분석팀: [✅동의 / ⚠️부분동의 / 🔴이견] — [동의·부분동의·이견 구분 없이 한 줄 근거 필수]

📌 내일 포트폴리오 액션
▶ [신규/조정/청산]: [종목명(코드) + thesis 기반 이유 한 줄] / 없으면: 변동 없음
▶ 유지 재확인: [종목 목록] — thesis 유효

📊 오늘 시장 핵심
오늘 이슈: [핵심 이슈] → [단발: 1회성 재료 / 트렌드: 구조적 흐름] — [판단 근거]
섹터 흐름: 강세 [섹터+수치] | 약세 [섹터+수치]

⚠️ 내일 시나리오 (확률 합계 100%)
강세 [X%]: [조건] → [수혜 섹터]
약세 [Y%]: [조건] → [주의 섹터]
야간 주목: [미국 이벤트·발표] (한국시간 기준 예상 시각)

💡 CIO 한마디
[오늘 시장 교훈 또는 내일 원칙 — 수치나 구체적 조건 포함 1~2줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━
...
[출력 형식 — 아래 구조 그대로, [CIO 핵심 수치 팩트 시트]와 실시간 수급 데이터를 그대로 사용]

🎯 오전 결론
KOSPI [수치]([+/-X.X%]) | 외국인 [+/-XXX억원] | 기관 [+/-XXX억원] | 주도: [섹터]
장전 예상 vs 실제: [✅일치 / ❌불일치] — [원인 수치 포함 한 줄]
오늘 결정: [✅유지 / ⚠️수정] — [이유]
분석팀: [✅동의 / ⚠️부분동의 / 🔴이견] — [동의·부분동의·이견 구분 없이 한 줄 근거 필수]

📌 오후 포트폴리오 행동
▶ [집행 / 보류 / 청산] — [구체적 종목·비중·이유]
오후 주목: S&P500선물 [수치]([+/-X%]) | USD/KRW [수치] | 수혜 섹터: [섹터]

⚠️ 오후 핵심 리스크
[오후에 주의할 것 — 구체적 조건·수치 포함 한 줄]

💡 CIO 한마디
[오전 흐름 해석 + 오후 원칙 — 구체적 수치나 조건 포함 1~2줄]
━━━━━━━━━━━━━━━━━━━━━━━━━━

총 20줄 이하. 괄호·예시 텍스트 절대 출력 금지. [CIO 핵심 수치 팩트 시트] 수치만 인용."""
...
외국인 누계: [+/-XXX억원] | 기관: [+/-XXX억원]
오늘 결정: [✅유지 / ⚠️수정] — [이유 수치 포함]
분석팀: [✅동의 / ⚠️부분동의 / 🔴이견] — [동의·부분동의·이견 구분 없이 한 줄 근거 필수]
...
오늘 핵심: [이슈] → [단발: 1회성 재료 / 트렌드: 구조적 흐름] — [판단 근거]
강세 [X%]: [조건] / 약세 [Y%]: [조건]
야간 주목: [미국 이벤트] (한국시간 기준 예상 시각)
