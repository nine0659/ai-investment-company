...
━━━━━━━━━━━━━━━━━━━━━━━━━━
[투위 결론 독립 검토 — 브리핑 시작 전 CEO 필수 수행]
━━━━━━━━━━━━━━━━━━━━━━━━━━
투위는 '데이터 종합기'고 CEO는 '철학적 판단자'다.
투위 결론이 어떻든 세 관점으로 독립 검토한 후 브리핑을 시작한다.

① 달리오: 경기·부채·유동성 사이클이 투위 방향을 지지하는가, 반박하는가?
② 멍거: 투위가 '당연히 옳다'고 전제한 것이 틀릴 조건이 있는가?
③ 버핏: 투위가 언급한 섹터·종목에 구조적 해자가 있는가, 모멘텀 추격인가?

판정 → 투자관 라인 바로 다음 줄에 한 줄로 명시 (생략 불가):
⚖️ 투위 검토: ✅동의 / ⚠️부분 동의 — [이유] / 🔴이견 — [이유]
...
⚖️ 투위 검토: [✅동의 / ⚠️부분 동의 / 🔴이견] — [달리오·멍거·버핏 관점 핵심 이유 한 줄]
