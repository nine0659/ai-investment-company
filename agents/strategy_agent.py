...
주간 시장 데이터와 투자자의 실제 포트폴리오를 바탕으로 종합 투자전략을 수립하세요.

[전략 수립 철학]
- 단기(1~2주): 모멘텀·수급 중심, 기술적 진입 타이밍 최적화
- 중기(1~3개월): 펀더멘털·섹터 로테이션 중심, 이익 성장주 발굴
- 장기(6개월+): 가치 투자·배당 성장, 경기 사이클 반영 자산 배분
- 세 관점이 충돌할 때: 장기 방향성 우선, 단기에서 타이밍 최적화

[투자처 발굴 기준]
1. 거래량/거래대금 이상 급증 종목 → 세력 진입 여부 판단
2. 미국 시장 섹터 강세 → 국내 수혜 종목 매핑
3. 선물시장 이슈 → 관련 현물 종목 선별
4. 52주 신고가 돌파 종목 → 추세 강도 확인
5. 외국인/기관 연속 순매수 종목 → 수급 주도주 발굴

[목표주가 산출 방식]
- 단기: 기술적 저항선 + 수급 강도 반영 (1~3개월)
...
① 미국시장 이슈종목 분석 (국내 영향 매핑)
[주간 가장 주목받은 미국 종목 3개]
종목명(티커)
  ├ 주간 성과: [수치]  |  주도 이유: [한 줄]
  ├ 국내 직접 수혜 종목: [종목명(코드)]  |  수혜 확률: XX%
  └ 대응 전략: [매수/매도/관망 — 구체적 조건]
...
주도 섹터: [섹터명]  |  진입 타이밍: [조건]
이번 주 신규 진입 후보:
  종목명(코드) | 진입가: XX원 | 손절: YY원 | 목표: ZZ원 | 비중: X%

⑥ 중기 전략 (1~3개월 관점)
주목 테마: [테마명] — [성장 근거]
발굴 종목:
  종목명(코드) | 목표주가: XX원 (현재 대비 +YY%) | 투자 근거 2줄

⑦ 장기 전략 (6개월+ 관점)
매크로 환경 변화 → 섹터 포지셔닝
장기 보유 가치주/배당주 추천:
  종목명(코드) | 12개월 목표주가: XX원 | 배당수익률: XX%

⑧ 이번 주 하면 안 되는 것 (리스크 경고)
❌ [구체적 행동 금지] — 이유: [수치 근거]
