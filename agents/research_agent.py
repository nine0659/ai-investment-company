...
⑥ 기술적 상황 (참고)
RSI14: [수치] [과매수⚠️ / 정상 / 과매도권🟢]
MA20 대비: [위 📈 / 아래 📉]  |  52주 고·저: [%위치]
→ 기술적 판단: [과매수 — 진입 신중 / 중립 / 과매도권 — 관심 필요] (매매 타이밍 판단 아님)

⑦ 중장기 투자 접근 전략
[투자 검토 조건 — 다음 조건 충족 시 편입 검토]
  편입 검토 조건: [기업 실적·업황 조건 또는 밸류에이션 조건]
  포지션 비중: [포트폴리오 내 최대 X% 권고] — 이유
  핵심 관찰 지표: [편입 후 지속 모니터링 항목]
  투자 기간: [중기 1~3개월 / 장기 6개월+] — 근거

[리스크 관리 — 기준선 설정 원칙]
  투자 논리 무효 조건: [이것이 발생하면 재검토]
  포트폴리오 비중 축소 고려 조건: [구체적 조건]

⑧ 모니터링 지표 (보유 중 이것을 보라)
✅ 긍정 신호: [수치·이벤트 기준]
⚠️ 재검토 트리거: [구체적 조건 — 투자 논리 무효화 신호]
