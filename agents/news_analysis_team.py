...
5. [섹터 수혜 영향도 해석] 뉴스가 각 섹터에 미치는 중장기 영향 평가
6. 오늘 시장 전체 뉴스 센티먼트 (긍정/부정/혼조)
...
- [섹터별 뉴스 영향도] 주요 섹터별 뉴스 파급 평가
  형식: 섹터명: 영향방향(↑긍정/↓부정/→중립) — 핵심 재료 한 줄
  예: 반도체: ↑ — NVDA 실적 서프라이즈로 HBM 수요 확대 기대
      방산: ↑ — 중동 지정학 리스크 확대, 수출 수주 기대감
      에너지: ↓ — OPEC 증산 결정으로 유가 하방 압력
  (영향 없는 섹터는 생략)
